...
class CafeForm(FlaskForm):
    ...
    rating = SelectField('Coffee Rating', choices=coffee_choices, validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        new_row = [form.cafe.data, form.loc.data, form.opening.data, form.closing.data, form.rating.data, form.wifi.data, form.power.data]
